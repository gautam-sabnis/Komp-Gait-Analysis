...
def main():
    ...
    for key in ordered_keys:
        tip_tail_lat_df_dict[key].to_csv('../Data/Phase_dfs/tip_tail/' + str(key) + '.csv') 
        base_tail_lat_df_dict[key].to_csv('../Data/Phase_dfs/base_tail/' + str(key) + '.csv')
        nose_lat_df_dict[key].to_csv('../Data/Phase_dfs/nose/' + str(key) + '.csv')     
